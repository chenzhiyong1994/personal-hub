...
- **可访问的交互**：包含跳转到主内容、键盘焦点、语义化标签页、外部链接提示与 `prefers-reduced-motion` 适配。
...
| 章节 | 作用 |
| --- | --- |
| Hero | 用一句主张和有限的身份信息建立第一印象 |
| 职业基本盘 | 用四组可核验的业务结果建立信任 |
| 产品实践 | 以项目索引、视觉舞台和页面内档案呈现八个代表项目 |
| 工作系统 | 展示内容、AIGC、求职、小说与产品工作的复用机制 |
